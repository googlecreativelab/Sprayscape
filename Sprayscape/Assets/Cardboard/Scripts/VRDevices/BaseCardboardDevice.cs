...
#endif
{
  ...
  private Matrix4x4 screenOrientationMatrixFix;
  ...
  public override void Init() {
    ...
    if (Screen.orientation == ScreenOrientation.Portrait)
        screenOrientationMatrixFix = Matrix4x4.TRS(Vector3.zero, Quaternion.Euler(0, 0, 90), new Vector3(1, 1, 1));
    else
        screenOrientationMatrixFix = Matrix4x4.identity;
  }
  ...
  public override void UpdateState() {
    ...
    headPose.SetRightHanded(headView.inverse * screenOrientationMatrixFix);
  }
